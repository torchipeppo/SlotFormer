...
class SlotFormerParams(BaseParams):
    ...
    # data settings
    dataset = 'intervpong'
    data_root = 'data/interventional_pong/dataset_BIGBALLv5a_more_finetune_samples'
    n_sample_frames = 16  # train on video clips of 6 frames
    ...
    enc_dict = dict(
        ...
        enc_ks=5,
        visual_resolution=(16,16),  # was (64,64)
