...
class Tokenizer(nn.Module):
    ...
    def decode_from_tokenidx(self, tokens: torch.Tensor, *, h, w, should_postprocess: bool = False) -> torch.Tensor:
        # shape = tokens.shape # (don't care about how many dimensions you put, I'll flatten this and recover the same later)
        ...
        # decoded = decoded.reshape(*shape[:-2], *decoded.shape[1:])  # (..., c, h, w)
        return decoded
